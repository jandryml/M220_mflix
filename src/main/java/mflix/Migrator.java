...
public class Migrator {
    ...
    public static void main(String[] args) {
        ...
        String mongoUri = "mongodb+srv://root:password1234@mflix.fhjfter.mongodb.net/admin?replicaSet=atlas-c40nsb-shard-0&readPreference=primary&connectTimeoutMS=10000&authSource=admin&authMechanism=SCRAM-SHA-1";
